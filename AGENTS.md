...
| DynamicTable | `@/components/shared/table` (`DynamicTable`, `DataTableFrame`, `TablePageViewport`) | `.docs/components/tables.md` | `dynamic-table.mdc` |
